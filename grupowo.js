...
(function() {
    ...
    const rows = [
        ...
        ["Aplauz i słowa zachęty oraz uznania.", "Pozbądź się tego", "Spośród odkrytych kart ”Przekonanie” wybierz tę, która zawiera przekonanie, jakiego pragniesz się pozbyć. Jeśli wszystkie twoje karty ”Przekonanie” są zakryte, odkryj jedną. Jeśli nie masz żadnej, wylosuj jedną. Skopiuj i wklej odpowiadający numer Dobrego Przekonania. Powiedz zdecydowanie i z przekonaniem: ”Całkowicie pozbywam się TERAZ z mojej świadomości i podświadomości przekonania, że (odczytaj tekst z karty). A teraz w miejsce tego przekonania do mojej świadomości i poświadomości zapraszam nowe, odwrotne przekonanie że ____________.”. Odłóż kartę na bok."],
